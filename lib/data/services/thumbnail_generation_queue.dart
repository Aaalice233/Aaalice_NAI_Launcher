...
class ThumbnailGenerationQueue {
  ...
  /// 任务队列（按优先级排序）
  final PriorityQueue<ThumbnailQueueTask> _taskQueue =
      PriorityQueue<ThumbnailQueueTask>(
  ...
  String getStatusReport() {
    ...
    buffer.writeln('Active Generations: ${stats['activeGenerations']}/${stats['maxConcurrentGenerations']}');
    buffer.writeln('');
