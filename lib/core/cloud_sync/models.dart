...
/// Hard limit for each encrypted object sent to or received from a backend.
const maxCloudObjectBytes = 4 * 1024 * 1024;

/// AES-GCM adds a 12-byte nonce and a 16-byte authentication tag.
const cloudObjectEncryptionOverhead = 28;
const maxCloudClearObjectBytes =
