    ...
    try {
      ...
      try {
        ...
        if (aspectRatio > targetWidth / targetHeight) {
          // 图片较宽，以宽度为准
          thumbnailHeight = (targetWidth / aspectRatio).round();
        } else {
          // 图片较高，以高度为准
          thumbnailWidth = (targetHeight * aspectRatio).round();
        }
        ...
        // 注意：image 包 4.x 版本的 Image 类没有 dispose() 方法
        // 资源由 Dart GC 自动管理
      }
