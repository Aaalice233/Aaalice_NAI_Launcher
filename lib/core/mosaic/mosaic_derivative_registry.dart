...
class MosaicDerivativeLink {
  const MosaicDerivativeLink({
...
/// App-private association between a redacted derivative and its original.
///
/// Paths never enter image metadata and the registry is deliberately not part
/// of cloud-sync allowlists.
class MosaicDerivativeRegistry {
  MosaicDerivativeRegistry(this._storage);

  static const _maxEntries = 500;
  final LocalStorageService _storage;

  MosaicDerivativeLink? find(String outputPath) {
    final entries = _read();
