    ...
    try {
      ...
      if (await dbFile.exists()) {
        try {
          ...
          AppLogger.w('Database file is locked, attempting to delete and recreate: $e', 'DanbooruTagsSqlite');
          try {
            await dbFile.delete();
            AppLogger.i('Locked database file deleted successfully', 'DanbooruTagsSqlite');
          } catch (deleteError) {
            AppLogger.e('Failed to delete locked database file', deleteError, null, 'DanbooruTagsSqlite');
          }
        }
      }
