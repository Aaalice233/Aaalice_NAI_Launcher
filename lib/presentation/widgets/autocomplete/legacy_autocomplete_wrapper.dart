...
/// )
/// ```
class LegacyAutocompleteWrapper extends ConsumerStatefulWidget {
  /// 被包装的输入组件
  final Widget child;
  ...
  const LegacyAutocompleteWrapper({
    super.key,
    required this.child,
  ...
  /// 便捷构造：使用本地标签策略
  factory LegacyAutocompleteWrapper.localTag({
    Key? key,
  ...
  /// 便捷构造：使用本地标签 + 别名策略
  factory LegacyAutocompleteWrapper.withAlias({
    Key? key,
    required Widget child,
    required TextEditingController controller,
    required WidgetRef ref,
  ...
  @override
  ConsumerState<LegacyAutocompleteWrapper> createState() =>
      _LegacyAutocompleteWrapperState();
}
...
class _LegacyAutocompleteWrapperState
    extends ConsumerState<LegacyAutocompleteWrapper> {
  ...
  @override
  void didUpdateWidget(LegacyAutocompleteWrapper oldWidget) {
