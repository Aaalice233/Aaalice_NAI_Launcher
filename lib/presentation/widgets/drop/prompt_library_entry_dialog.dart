...
class PromptLibraryEntryDialog extends ConsumerStatefulWidget {
  ...
  static Future<bool?> show(
    ...
    return showDialog<bool>(
      context: context,
      builder: (context) => PromptLibraryEntryDialog(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        context.l10n.drop_promptLibraryTitle,
                ...
                if (_mode == PromptLibraryWriteMode.create) ...[
                  ...
                  if (_mode == PromptLibraryWriteMode.append) ...[
                    ...
                    SafeDropdown<PromptAppendSeparator>(
                      ...
                      onChanged: (value) {
                        if (value != null) setState(() => _separator = value);
                      },
                    ),
                  ],
                ],
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    helperText: context.l10n.drop_promptLibraryExactContentHint,
                  ),
                ),
                if (_mode == PromptLibraryWriteMode.append &&
                    targetEntry != null) ...[
                ...
                Row(
                  ...
                  children: [
                    ...
                    FilledButton(
                      onPressed: _canSave(entries)
                          ? () => _save(entries, targetEntry)
                          : null,
                      child: _saving
                          ...
                          : Text(
                              _mode == PromptLibraryWriteMode.overwrite
                                  ? context
                                        .l10n
                                        .drop_promptLibraryConfirmOverwrite
