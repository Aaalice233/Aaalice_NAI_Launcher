          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    _buildProbabilityBar(
                        context, theme, '1人 (solo)', 70, Colors.blue,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(
                        context, theme, '2人 (2girls等)', 20, Colors.green,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(
                        context, theme, '3人 (multiple)', 7, Colors.orange,),
                    const SizedBox(height: 6),
              ...
              _buildSection(
                ...
                child: Column(
                  children: [
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_background, 90, Colors.teal,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_hairColor, 50, Colors.purple,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_eyeColor, 50, Colors.blue,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_hairStyle, 50, Colors.pink,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_expression, 50, Colors.amber,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_pose, 50, Colors.indigo,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_clothing, 50, Colors.orange,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_accessory, 50, Colors.brown,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_scene, 50, Colors.green,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_style, 30, Colors.cyan,),
                    const SizedBox(height: 6),
                    _buildProbabilityBar(context, theme,
                        context.l10n.naiAlgorithm_bodyFeature, 30, Colors.grey,),
                  ],
                ),
              ),
