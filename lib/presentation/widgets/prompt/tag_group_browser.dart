...
class _TagGroupBrowserState extends ConsumerState<TagGroupBrowser> {
  ...
  String _getCategoryEmoji(TagSubCategory category) {
    return switch (category) {
      ...
      TagSubCategory.eyeFeature => '👁️',
      TagSubCategory.hairLength => '📏',
      TagSubCategory.hairTexture => '〰️',
      TagSubCategory.bangs => '💇',
      TagSubCategory.camera => '📷',
      TagSubCategory.framing => '🖼️',
      TagSubCategory.focus => '◎',
      TagSubCategory.skinTone => '🎨',
      TagSubCategory.species => '🐾',
      TagSubCategory.headwear => '🧢',
      TagSubCategory.hairAccessory => '🎀',
      TagSubCategory.prop => '🧰',
      TagSubCategory.effect => '✨',
      TagSubCategory.year => '📅',
      TagSubCategory.detail => '◇',
