          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _sectionTitle(context.l10n.cloudSync_lightweightData),
                _toggle(
                  key: 'settings',
                ...
                _toggle(
                  ...
                  subtitle: context.l10n.cloudSync_promptsAndTagsDescription,
                ...
                _toggle(
                  ...
                  subtitle:
                      context.l10n.cloudSync_onlineGallerySettingsDescription,
                  value: _selection.includeOnlineGallerySettings,
                  onChanged: (value) => _update(
                    _selection.copyWith(includeOnlineGallerySettings: value),
                  ),
                ),
                _toggle(
                  ...
                  subtitle:
                      context.l10n.cloudSync_onlineGalleryFavoritesDescription,
                  value: _selection.includeOnlineGalleryFavorites,
                  onChanged: (value) => _update(
                    _selection.copyWith(includeOnlineGalleryFavorites: value),
                  ),
                ),
                _toggle(
                  key: 'gallery-albums',
                  ...
                  onChanged: (value) =>
                      _update(_selection.copyWith(includeGalleryAlbums: value)),
                ),
                const SizedBox(height: 20),
                _sectionTitle(context.l10n.cloudSync_optionalResources),
