...
/// 2. 实时预览发送效果
/// 3. 别名解析开关
class SendToHomeDialogV2 extends ConsumerStatefulWidget {
  final TagLibraryEntry entry;

  const SendToHomeDialogV2({
    super.key,
    required this.entry,
  });
  ...
  static Future<SendOptions?> show(
    ...
    return showDialog<SendOptions>(
      context: context,
      builder: (context) => SendToHomeDialogV2(entry: entry),
    );
  }

  @override
  ConsumerState<SendToHomeDialogV2> createState() =>
      _SendToHomeDialogV2State();
}

class _SendToHomeDialogV2State extends ConsumerState<SendToHomeDialogV2> {
